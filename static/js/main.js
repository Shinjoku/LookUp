...
function menu(){
	...
	ctx.font = "10px Arial";
	ctx.fillStyle = "red";
	ctx.fillText("Pressione Enter",(winWidth/2) - (winWidth/40),winHeight/2);
	ctx.fillText("Para Jogar", (winWidth/2) - (winWidth/40), (winHeight/2)+(winHeight/50));
	window.requestAnimationFrame(vetorCena[count])
...
function endGame(){
	...
	ctx.fillText("Precione SPACE", (winWidth/2) - (winWidth/40), (winHeight/2)+(winHeight/50))
	ctx.fillText("para reiniciar", (winWidth/2) - (winWidth/40), (winHeight/2)+(winHeight/100))
	window.requestAnimationFrame(vetorCena[count])
